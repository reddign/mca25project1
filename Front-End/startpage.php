...
<body>
    ...
    <nav class="main-nav"> 
        <ul class="nav-list">
            ...
            <li class="nav-item page"> <a href="login.php" class="w3-bar-item w3-button">Login Here</a> </li>
            <li class="nav-item page"> <a target="_blank" href="register.php" class="w3-bar-item w3-button">Register Here!</a> </li>
            <li class="nav-item logo"> 
                <a href="http://127.0.0.1/MCA25PROJECT1/Front-End/login.php">
